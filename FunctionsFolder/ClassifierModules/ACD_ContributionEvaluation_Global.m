...
function [FeatureContributionsWithOrgOrder, OutFeatures] = ACD_ContributionEvaluation_Global_v16p0(ClassesData,FeaturesVector,Top_N_Percent,AccuraciesVector,AllPossibleCombinations,BypassAccuracyCheck,IgnoreBaseContribution,Options)
...
if IgnoreBaseContribution == false
    BaselineAccuracy = ACD_ContributionBaseValue_v16p0(ClassesVector);
else
    BaselineAccuracy = 0;
end
