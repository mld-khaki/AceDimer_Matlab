...
% $Revision: 3.1.0 $  $Date: _2022_05_08___13_39_18_Sun  Adding Analysis info to input array to use MRMR data in contribution 

function    [ContributionsFeaturesNewRank, NextFeatureCount] = ACD_CalculateNextSetCount_Global_v3p1p0(PrvResults,DblPrvResults,TestAnalysisInfo,TestResults,ClassesData,Options,AnalysisInfo)
...
% 		PrvResults.ConfusionMatrices,...
    ContributionResults = ACD_AUX_CalculateContributions_v3p3p0('AceDimerv3p0p0',PrvResults,DblPrvResults,true,IgnoreBaseContribution,Options.Top_N_Percent);
