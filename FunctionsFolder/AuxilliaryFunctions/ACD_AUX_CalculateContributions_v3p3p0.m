...
function [AnalysisResults] = ACD_AUX_CalculateContributions_v3p3p0(Version,InpPrvResults,InpDblPrvResults,BypassAccuracyCheck,IgnoreBaseContribution,Top_N_Percent)
...
%         ContributionIndv = ContributionIndv* ConfScore^2;
        ...
        if isnan(ContributionIndv)
            ...
            for ciCtr=1:length(Vector)
                ...
                Out.Features(FeatInd).Contributions(end+1) = ContributionIndv;
