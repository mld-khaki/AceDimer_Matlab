...
function [AnalysisOut, SROut,Rankings] = ACD_ResultsTabulator_v2p0p0(Version,InputFolderOfResults,InputData,Top_N_Percent,SRIn,AnalysisInp)
...
% 	end
    ...
    ContAnalysisRes = ACD_AUX_CalculateContributions_v2p0p0(Version,...
		AllSRs,...
